...
const experts = [
  {
    ...
    bio: 'Especialista em treinamento funcional e reabilitação, Daniel garante que cada exercício seja seguro, eficaz e adaptado para você.',
  ...
  },
  {
    ...
    bio: 'Especialista em treinamento funcional e reabilitação, Gabriel garante que cada exercício seja seguro, eficaz e adaptado para você.',
  ...
  },
  {
    ...
    bio: 'Marina desenvolve os planos nutricionais anti-inflamatórios que aceleram sua recuperação e potencializam seus resultados.',
  ...
  },
  {
    name: 'Pedro Andrade',
    title: 'Educador Físico, CREF 12345-G/BR',
    bio: 'Nosso especialista em gamificação e engajamento, Pedro transforma a jornada de correção postural em um desafio motivador.',
  ...
  },
  {
    ...
    bio: 'Nosso especialista em gamificação e engajamento, Samuel transforma a jornada de correção postural em um desafio motivador.',
